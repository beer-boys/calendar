...
class FocusTimeEventProvider(
    ...
    override fun getEventsForUserOnDate(userId: UserId, date: LocalDate): List<SchedulableEvent> {
        ...
        return focusTimeRepository.findFocusTimes(userId, dayTimeSlot)
    }
